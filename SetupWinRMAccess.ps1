...
function InstallOpenSSL() {
    if (!(Test-Path $opensslPath)) {
        # TODO(cpopa): dehardcode this, if possible.
        $filename = "$ENV:Temp\Win32OpenSSL_Light-1_0_1j.exe"
        Invoke-WebRequest -Uri "https://slproweb.com/download/Win32OpenSSL_Light-1_0_1j.exe" -OutFile $filename
...
$SetupWinRMAccessSelfSignedLUrl = "https://raw.github.com/PCManticore/windows-openstack-imaging-tools/master/SetupWinRMAccessSelfSigned.ps1"
